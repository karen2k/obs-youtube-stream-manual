...
* Растяните и переместите изображение на ваш вкус

### Настройка видео камеры

**Требуется второй монитор**
...
* Нажмите "Ок" / "Ok"
* В основном окне программы вы должны видеть изображение с камеры. Если оно занимает на все окно, измените его размер, потянув за нижний правый красный квадрат.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjkxMjg0NiwtMTc3OTA0MjcwOCwtMT
